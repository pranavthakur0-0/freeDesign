      ...
      <div className="main-landing">
        <div className="main-home">
          <div className="landing">
            ...
            <Typewriter
              options={{
                strings: ["Technology.", "Security.", "CybrBridge"],
                autoStart: true,
                loop: true,
              }}
            />
            </span>
            <p>Secure your future with us in this digital world.</p>
            <Lin  to="text-wrapper" spy={true} smooth={true}>
          ...
          <div className="wrapper">
            ...
            <div className="text-wrapper" id="text-wrapper">
              ...
              <p>
                ...
                omnis esse minima corporis commodi adipisci, iusto possimus,
                odio eveniet iste amet explicabo quidem id molestias fuga,
                tempore numquam perferendis enim. Lorem ipsum dolor sit amet
                consectetur adipisicing elit. Asperiores itaque deserunt dolore
                non vel perspiciatis quia ipsa optio accusamus est saepe
                officiis, accusantium ipsum nulla aut harum ducimus atque
                consequuntur.
              </p>
              <ul>
                <li>
        ...
        <div className="home-how-it-works">
          <div className="heading">
            ...
            <p>
              ...
              itaque nemo enim animi quasi dolor temporibus sint porro,
              inventore ad.
            </p>
          </div>
          <div className="wrapper">
              ...
              <div className="shape-wrapper">
                ...
                <div className="shape">
                  <div className="shape-container">
                    <Marquee
                      className="circular-marquee"
                      speed={30}
                      gradient={false}
                      direction="left"
                    >
                      01000101 01111000 01100001 01101101 01110000 01101100
                      0110010101000101 01111000 01100001 01101101 01110000
                      01101100 0110010101000101 01111000 01100001 01101101
            ...
            <div className="how-it-works-two">
              <div className="cards">
                ...
                <div className="card-text">
                  Build detection rules across your apps and clouds.
                </div>
              </div>
              <div className="cards">
                <div className="card-heading">
                ...
                <div className="card-text">
                  High accuracy machine learning classification for any
                  sensitive data, including PIl, credentials, keys, secrets, and
                  more
                </div>
              </div>
              <div className="cards">
                ...
                <div className="card-text">
                  Real-time alerts and remediation with Skulight's central
                  console.
                </div>
              </div>
            </div>
